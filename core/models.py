...
class Notas(models.Model):
    ...
    Estudiante_ID = models.ForeignKey(Estudiante, on_delete=models.CASCADE, related_name="notas")
    Curso_ID = models.ForeignKey(Curso, on_delete=models.CASCADE, related_name="notas")
